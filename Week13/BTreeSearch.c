...
/*
    root = insert(root, "John", "john@email.com");
    insert(root, "Jane", "jane@email.com");
    insert(root, "Jim", "jim@email.com");
    insert(root, "Jake", "jake@email.com");

    print_tree(root);
    printf("Searching for Jim: ");
    node *result = search(root, "Jim");
    if (result != NULL)
    ...
    root = Remove (root, "Jane");
    printf("Searching for Jane: ");
    result = search(root, "Jane");
    if (result != NULL)
        printf("Name: %s, Email: %s\n", result->name, result->email);
    else
        printf("Data not found\n");
